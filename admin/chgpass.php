...
<head>
	...
	<title>ADMIN PANEL | Reset password for user</title>
...
<body>
		...
		<div class="tab">
			...
			<div class="tab-item selected"><a href="chgpass.php">Reset password for user</a></div>
		</div>

		<div class="container">
			<div class="title" style="text-align: center; " >Reset password for user</div>
			...
			<div>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							<td colspan="2"><label><input type="Checkbox" required="true">&nbsp&nbspConfirm reset password for this user.</label></td>
						</tr>
						<tr>
							<td></td>
							<td><input type="submit" name="change" value="Reset Password"></td>
						</tr>
					</tbody>
				</table>
				</form>
			...
			<div>
				<?php }
					if ($_POST['change']=="Reset Password"){
						if (!preg_match("/^[A-Za-z0-9]+$/",$_POST['username']))
							die("Invalid username.");
						mysqli_query($con,"UPDATE info SET password='".md5($_POST['dob'])."' where username='".$_POST['username']."'");
						$_POST['change']="";
